...
Since swap can also work only one way, if a party enters the system with zero ether (\gloss{newcomer}), but connects to peers with funds (\gloss{insider}), first they just provide the service (and not use it)
